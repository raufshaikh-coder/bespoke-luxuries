  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {brandCategories.map((category, categoryIndex) => (
        <section
          key={categoryIndex}
          className={`py-24 ${categoryIndex % 2 === 0 ? "bg-card border-y border-border" : ""}`}
        >
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {category.brands.map((brand, brandIndex) => (
                ...
                >
                  <h3 className="font-display text-2xl text-foreground mb-3 group-hover:text-primary transition-colors duration-300 tracking-wide">
                    {brand.name}
                  </h3>
      ...
      <section className="py-28">
        <div className="container mx-auto px-6 text-center">
          ...
          <h3 className="font-display text-2xl text-foreground mb-10">
            We source from over <span className="text-primary">100+ luxury brands</span> worldwide
          </h3>
